...
# Parámetros
# ========================================
file_in = "orbita_marte.dat" # Nombre del fichero de datos
file_out = "orbita2" # Nombre del fichero de salida (sin extensión)
...
interval = 100 # (100) Tiempo entre fotogramas en milisegundos
