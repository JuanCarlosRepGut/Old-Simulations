...
with open(nombre_archivo, 'r') as archivo:
    ...
    etiquetas=["Patrón 1 ; D=0.2","Patrón 2 ; D=0.2","Patrón 3 ; D=0.2","Patrón 4 ; D=0.2","Patrón 1 ; D=0.4","Patrón 2 ; D=0.4","Patrón 3 ; D=0.4","Patrón 4 ; D=0.4"]
    plt.legend(etiquetas,loc='lower right')
