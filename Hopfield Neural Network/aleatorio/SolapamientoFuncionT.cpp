...
int main(void)
{
    ...
    FILE *fspin, *fpatron, *fsolapamiento, *fsolapamientoT; //Punteros a los ficheros
    ...
    N=30;
    pasos=30; //Se toman menos pasos para reducir el tiempo de compilación del programa
...
//Aqui comienza el bucle que recorre todas las temperaturas
    for(t=0;t<100;t++)
    {
        if(t==0)
        T=0.0001;
        ...
        T=0.001*t;
//Reestablecemos la posición inicial en cada temperatura.
    randspininicial(s,N);
